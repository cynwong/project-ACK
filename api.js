$(document).ready(function () {
    ...
    $(".submit").on("click", function (event) {
        ...
        $.ajax({
            ...
            var thirdqueryURL = "https://app.ticketmaster.com/discovery/v2/events.json?classificationName=music&countryCode="+ countryCode +"&startDateTime=2019-11-16T14:00:00Z&endDateTime=2019-12-31T14:00:00Z&city=melbourne&apikey=J1LIFHjLvkNEcD4gPnYHGcQNfXstsT5J"
            $.ajax({
                url: thirdqueryURL,
                method: "GET"
            }).then(function (response) {
